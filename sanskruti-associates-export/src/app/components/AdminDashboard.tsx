...
export function AdminDashboard() {
  ...
  const recentLeads = [
    { name: 'Rajesh Kumar', phone: '+91 98765 43210', loanType: 'Home Loan', amount: '₹45,00,000', status: 'Approved', date: '05 May 2026' },
    { name: 'Priya Sharma', phone: '+91 98765 43211', loanType: 'Personal Loan', amount: '₹5,00,000', status: 'Pending', date: '04 May 2026' },
    { name: 'Amit Patel', phone: '+91 98765 43212', loanType: 'Business Loan', amount: '₹25,00,000', status: 'Approved', date: '04 May 2026' },
    { name: 'Sneha Reddy', phone: '+91 98765 43213', loanType: 'Car Loan', amount: '₹8,00,000', status: 'Pending', date: '03 May 2026' },
    { name: 'Vikram Singh', phone: '+91 98765 43214', loanType: 'Education Loan', amount: '₹12,00,000', status: 'Rejected', date: '03 May 2026' },
  ];
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="text-sm">
                  ...
                  <div className="text-gray-500 text-xs">admin@sanskruti.com</div>
                </div>
            ...
            <div className="bg-white rounded-2xl p-6" style={{ boxShadow: '0 2px 12px rgba(0,0,0,0.08)' }}>
              ...
              <div className="space-y-2">
                {[
                  ...
                  { label: 'Personal Loan', color: '#16A34A', percent: '20%' },
                  { label: 'Business Loan', color: '#F59E0B', percent: '16%' },
