          ...
          {loanTypes.map((loan, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative rounded-2xl p-6 bg-white group cursor-pointer transition-all duration-300"
                style={{
              ...
              >
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <motion.button
                    ...
                    className="relative overflow-hidden px-5 py-2.5 rounded-xl text-sm font-semibold text-white transition-all duration-300"
                    style={{
