...
const employmentTypes = [
  ...
  {
    id: 'Self Employed / Business Owner',
...
export function HomeLoanForm() {
  ...
  const buildWhatsAppMessage = () => {
    const appId = applicationId || `HL-${Date.now().toString().slice(-8)}`;
    
    let message = `*SANSKRUTI ASSOCIATES*\n*New Loan Application*\n\n━━━━━━━━━━━━━━━━━━━━\n\n● Application ID: *${appId}*\n● Loan Type: *Home Loan*\n\n━━━━━━━━━━━━━━━━━━━━\n\n*● EMPLOYMENT TYPE*\n1. ${employmentType}\n\n*● PERSONAL DETAILS*\n1. Name: ${formData.fullName}\n2. Date of Birth: ${formData.dateOfBirth}\n3. PAN Number: ${formData.panNumber}\n4. Aadhaar Number: ${formData.aadhaarNumber}\n5. Address: ${formData.currentAddress}\n6. City: ${formData.city}\n7. PIN Code: ${formData.pinCode}\n8. Co-applicant Name: ${formData.coApplicantName || 'N/A'}\n9. Co-applicant PAN: ${formData.coApplicantPan || 'N/A'}\n10. Co-applicant Aadhaar: ${formData.coApplicantAadhaar || 'N/A'}\n\n*● LOAN DETAILS*\n1. Property Location: ${formData.propertyLocation}\n2. Property Type: ${formData.propertyType}\n3. Loan Amount: ₹${formatCurrency(formData.loanAmount)}\n4. Tenure: ${formData.loanTenure} months\n5. Monthly Income: ₹${formatCurrency(formData.monthlyIncome)}\n6. Existing EMI: ₹${formData.existingEmi ? formatCurrency(formData.existingEmi) : '0'}\n\n━━━━━━━━━━━━━━━━━━━━\n\nPlease review and get back to me regarding my application.`;
  ...
  if (submitted) {
    ...
    return <LoanSuccessCard 
      ...
      contactMessage="Our team will contact you within 2 hours."
    />;
  }
                ...
                <div className="grid gap-5 md:grid-cols-2">
                  ...
                  <Field label="Property Type">
                    <select
                      ...
                      onChange={(event) => updateFormData('propertyType', event.target.value)}
            ...
            <div className="[animation:loanStepIn_0.3s_ease-in-out_both]">
              ...
              <div className="space-y-5">
                <div className="rounded-2xl border border-blue-100 bg-blue-50/80 p-5 shadow-sm">
                  ...
                  <p className="text-lg text-[#1F2937]">Home Loan</p>
                </div>
                ...
                <div className="rounded-2xl border border-gray-100 bg-white/80 p-5 shadow-sm">
                  ...
                  <div className="grid gap-3 text-gray-700 md:grid-cols-2">
                    ...
                    <p>Monthly Income: Rs. {formatCurrency(formData.monthlyIncome)}</p>
                    {formData.existingEmi && <p>Existing EMI: Rs. {formatCurrency(formData.existingEmi)}</p>}
                  </div>
                </div>
